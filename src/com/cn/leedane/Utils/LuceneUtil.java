...
public class LuceneUtil {
	...
	private LuceneUtil(){
		indexWriter = (IndexWriter) SpringUtils.getBean("indexWriter");
		analyzer = (IKAnalyzer) SpringUtils.getBean("analyzer");
		directory = (SimpleFSDirectory) SpringUtils.getBean("directory");
	}
