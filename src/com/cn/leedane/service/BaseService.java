...
public interface BaseService<T extends Serializable> {
	 ...
	 * @throws Exception
	 */
	public boolean updateBatch(String sql, int[] ids) throws Exception;
	 ...
	 * @throws Exception
	 */
	public boolean deleteById(String tableName, final int id) throws Exception;
	 ...
	 *        2、获取的是该表的全部字段
	 * @param tableName  表名
	 * @param where  where语句，参数直接填写在字符串中
	 * @param pageSize  每页条数
	 * @param pageNo  第几页
	 * @return
	 */
