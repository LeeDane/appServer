 ...
 * 收藏夹的Service类
 * @author LeeDane
 * 2016年1月12日 下午6:21:32
 * Version 1.0
 */
public interface CollectionService<T extends Serializable> extends BaseService<CollectionBean>{
	 ...
	 * @throws Exception
	 */
	public boolean addCollect(JSONObject jo, UserBean user, HttpServletRequest request);
