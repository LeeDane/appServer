 ...
 * 用户service接口类
 * @author LeeDane
 * 2015年7月17日 下午6:19:27
 * Version 1.0
 */
 
public interface UserService <T extends Serializable> extends BaseService<UserBean>{
	/**
	 * 通过Id找到对应的User
	 */
	 ...
	 * @return 
	 */
	public Map<String, Object> getPhoneLoginCode(JSONObject jo,
			HttpServletRequest request);
