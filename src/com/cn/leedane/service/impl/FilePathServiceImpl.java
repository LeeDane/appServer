 ...
 * 文件路径service实现类
 * @author LeeDane
 * 2015年11月22日 下午11:55:13
 * Version 1.0
 */
public class FilePathServiceImpl extends BaseServiceImpl<FilePathBean> implements FilePathService<FilePathBean> {
	...
	public boolean saveEachTemporaryBase64ToFilePath(JSONObject jo, UserBean user,
		...
		List<Map<String, Object>> contents = temporaryBase64Dao.executeSQL("select content from T_TEMP_BASE64 where uuid = ? temp_order = ? order by start asc", uuid, order);
