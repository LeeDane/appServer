...
public class SignInServiceImpl extends BaseServiceImpl<SignInBean> implements SignInService<SignInBean> {
	...
	public void setSignInDao(SignInDao<SignInBean> signInDao) {
	...
	public SignInDao<SignInBean> getSignInDao() {
		return signInDao;
	}
	...
	public boolean isSign(int userId, String dateTime) {
		return this.signInDao.isSign(userId, dateTime);
	}


	@Override
	public List<Map<String, Object>> getNewestRecore(int userId) {
		return this.signInDao.getNewestRecore(userId);
	}

	@Override
	public boolean hasHistorySign(int userId) {	
		return this.signInDao.hasHistorySign(userId);
	}
	...
	public boolean saveSignIn(JSONObject jo, UserBean user,
		...
		if(!hasHistorySign){
			...
			List<Map<String, Object>> yesTodayRecore = signInDao.getYesTodayRecore(uid);
		...
		boolean isSave = signInDao.save(signInBean, uid);
		if(isSave){
